  ...
  return (
    <footer className="py-8 px-5 md:grid md:grid-cols-2 flex flex-wrap justify-around gap-8 bg-white">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex gap-1.5">
            ...
            <a
              ...
              target="_blank"
              className="flex items-center underline p-16"
            >
          ...
          <div className="flex gap-1.5">
            ...
            <a href="tel:+33675669604" className="underline p-16">06.75.66.96.04</a>
          </div>
          <div className="flex gap-1.5">
      ...
      <article className="flex flex-wrap justify-around gap-6">
        ...
        >
          <img src="/assets/logo/facebook.webp" alt="Lien vers facebook" className="w-14"/>
        </a>
        <a
