        ...
        <section className="section m-auto lg:w-[1024px] w-full flex flex-col gap-5">
          {recipeDetails !== undefined ? (
            <>
              ...
              <div className="pr-5 flex max-md:flex-col gap-5">
                <article className="flex flex-col items-center gap-0.5">
                  ...
                  <div className="p-5 lg:w-80 md:w-52 w-full flex flex-col gap-5 bg-green-200">
                    <div className="max-md:mx-auto max-md:w-52 flex flex-col gap-2.5">
                    ...
                    <div className="flex md:flex-col max-md:flex-wrap justify-around gap-2.5">
                      ...
                      <div className="flex flex-col gap-1">
                        {recipeDetails.ingredients.map((ingredients, index) => (
                          <p key={index} className="text text-white-200">
                            ...
                            {ingredients.dosage.length === 2 ||
                            ingredients.dosage.length === 1
                              ? ""
                              : " "}
                            {ingredients.dosage} {ingredients.name}
                          </p>
                        ))}
                      </div>
                    </div>
                ...
                <article className="pb-5 max-md:pl-5 lg:w-[calc(100%_-_20rem)] md:w-[calc(100%_-_13rem)] w-full flex flex-col gap-8">
